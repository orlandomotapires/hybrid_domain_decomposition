...
DEFAULT_PERCENT_BANDS = tuple(round(step * STEP_PERCENT, 10) for step in range(int(INITIAL_PERCENT / STEP_PERCENT), int(FINAL_PERCENT / STEP_PERCENT)))  # 0.0%, 0.05%, ..., 4.95%
